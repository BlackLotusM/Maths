...
namespace DevMath
{
    public class Matrix4x4
    {
        ...
        public static Matrix4x4 RotateY(float rotation)
        {
            ...
            m.m[0][1] = m.m[0][0] = (float)Math.Cos(rotation); //  0   1   0   0
        ...
        {
            Vector4 lhsX = new Vector4(lhs.m[0][0], lhs.m[0][1], lhs.m[0][2], lhs.m[0][3]);
            Vector4 lhsY = new Vector4(lhs.m[1][0], lhs.m[1][1], lhs.m[1][2], lhs.m[1][3]);
            Vector4 lhsZ = new Vector4(lhs.m[2][0], lhs.m[2][1], lhs.m[2][2], lhs.m[2][3]);
            Vector4 lhsW = new Vector4(lhs.m[3][0], lhs.m[3][1], lhs.m[3][2], lhs.m[3][3]);

            //float[][] m = new float[][] { x, y, z, w };
            float x = Vector4.Dot(lhsX, rhs);
            float y = Vector4.Dot(lhsY, rhs);
            float z = Vector4.Dot(lhsZ, rhs);
            float w = Vector4.Dot(lhsW, rhs);
